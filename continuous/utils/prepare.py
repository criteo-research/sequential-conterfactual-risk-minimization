...
estimator_dico = {
    ...
    'regips': 'RegressionIPS',
    'multi-ips': 'MultipleInversePropensityScore',
}
...
def get_optimizer_by_params(hyperparams):
    """ Gets optimizer according to hyperparameter choice
    ...
    optimizer_name = "src.optimizer.{}".format(name)
    mod = __import__(optimizer_name, fromlist=[optimizer_dico[name]])
    return getattr(mod, optimizer_dico[name])(hyperparams)
